...
<body>
    ...
    <div class="cart-sidebar-area">
        <div class="top-content">
            <a href="index.html" class="logo">
                <img src="{{ asset('sbidu/assets/images/logo/logo2.png') }}" alt="logo">
            </a>
        ...
        <div class="bottom-content">
            <div class="cart-products">
                ...
                <div class="single-product-item">
                    <div class="thumb">
                        <a href="#0"><img src="{{ asset('sbidu/assets/images/shop/shop01.jpg') }}" alt="shop"></a>
                    </div>
                    <div class="content">
                ...
                <div class="single-product-item">
                    <div class="thumb">
                        <a href="#0"><img src="{{ asset('sbidu/assets/images/shop/shop02.jpg') }}" alt="shop"></a>
                    </div>
                    <div class="content">
                ...
                <div class="single-product-item">
                    <div class="thumb">
                        <a href="#0"><img src="{{ asset('sbidu/assets/images/shop/shop03.jpg') }}" alt="shop"></a>
                    </div>
                    <div class="content">
                ...
                <div class="single-product-item">
                    <div class="thumb">
                        <a href="#0"><img src="{{ asset('sbidu/assets/images/shop/shop04.jpg') }}" alt="shop"></a>
                    </div>
                    <div class="content">
                ...
                <div class="single-product-item">
                    <div class="thumb">
                        <a href="#0"><img src="{{ asset('sbidu/assets/images/shop/shop05.jpg') }}" alt="shop"></a>
                    </div>
                    <div class="content">
    ...
    <div class="browse-section ash-bg">
                ...
                <div class="m--15">
                    <div class="browse-slider owl-theme owl-carousel">
                        <a href="#0" class="browse-item">
                            <img src="{{ asset('sbidu/assets/images/auction/01.png') }}" alt="auction">
                            <span class="info">Vehicles</span>
                        </a>
                        <a href="#0" class="browse-item">
                            <img src="{{ asset('sbidu/assets/images/auction/02.png') }}" alt="auction">
                            <span class="info">Jewelry</span>
                        </a>
                        <a href="#0" class="browse-item">
                            <img src="{{ asset('sbidu/assets/images/auction/03.png') }}" alt="auction">
                            <span class="info">Watches</span>
                        </a>
                        <a href="#0" class="browse-item">
                            <img src="{{ asset('sbidu/assets/images/auction/04.png') }}" alt="auction">
                            <span class="info">Electronics</span>
                        </a>
                        <a href="#0" class="browse-item">
                            <img src="{{ asset('sbidu/assets/images/auction/05.png') }}" alt="auction">
                            <span class="info">Sports</span>
                        </a>
                        <a href="#0" class="browse-item">
                            <img src="{{ asset('sbidu/assets/images/auction/06.png') }}" alt="auction">
        ...
        <section class="car-auction-section padding-bottom padding-top pos-rel oh">
            <div class="car-bg"><img src="{{ asset('sbidu/assets/images/auction/car/car-bg.png') }}" alt="car"></div>
            <div class="container">
                <div class="section-header-3" data-aos="zoom-out-down" data-aos-duration="1200">
                    <div class="left">
                        <div class="thumb">
                            <img src="{{ asset('sbidu/assets/images/header-icons/car-1.png') }}" alt="header-icons">
                        </div>
                ...
                <div class="row justify-content-center mb-30-none">
                    <div class="col-sm-10 col-md-6 col-lg-4">
                        <div class="auction-item-2" data-aos="zoom-out-up" data-aos-duration="2200">
                            <div class="auction-thumb">
                                <a href="./product-details.html"><img src="{{ asset('sbidu/assets/images/auction/car/auction-1.jpg') }}" alt="car"></a>
                    ...
                    <div class="col-sm-10 col-md-6 col-lg-4">
                        <div class="auction-item-2" data-aos="zoom-out-up" data-aos-duration="1100">
                            <div class="auction-thumb">
                                <a href="./product-details.html"><img src="{{ asset('sbidu/assets/images/auction/car/auction-2.jpg') }}" alt="car"></a>
                                <a href="#0" class="rating"><i class="far fa-star"></i></a>
                                <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                            </div>
                            <div class="auction-content">
                    ...
                    <div class="col-sm-10 col-md-6 col-lg-4">
                        <div class="auction-item-2" data-aos="zoom-out-up" data-aos-duration="1200">
                            <div class="auction-thumb">
                                <a href="./product-details.html"><img src="{{ asset('sbidu/assets/images/auction/car/auction-3.jpg') }}" alt="car"></a>
                                <a href="#0" class="rating"><i class="far fa-star"></i></a>
                                <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                            </div>
                            <div class="auction-content">
    ...
    <section class="jewelry-auction-section padding-bottom padding-top pos-rel">
        <div class="jewelry-bg d-none d-xl-block"><img src="{{ asset('sbidu/assets/images/auction/jewelry/jwelry-bg.png') }}" alt="jewelry"></div>
        <div class="container">
            <div class="section-header-3" data-aos="zoom-out-down" data-aos-duration="1200">
                <div class="left">
                    <div class="thumb">
            ...
            <div class="row justify-content-center mb-30-none">
                <div class="col-sm-10 col-md-6 col-lg-4">
                    <div class="auction-item-2" data-aos="zoom-out-up" data-aos-duration="1300">
                        <div class="auction-thumb">
                            <a href="./product-details.html"><img src="{{ asset('sbidu/assets/images/auction/jewelry/auction-1.jpg') }}" alt="jewelry"></a>
                            <a href="#0" class="rating"><i class="far fa-star"></i></a>
                            <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                        </div>
                        <div class="auction-content">
                ...
                <div class="col-sm-10 col-md-6 col-lg-4">
                    <div class="auction-item-2" data-aos="zoom-out-up" data-aos-duration="1400">
                        <div class="auction-thumb">
                            <a href="./product-details.html"><img src="{{ asset('sbidu/assets/images/auction/jewelry/auction-2.jpg') }}" alt="jewelry"></a>
                            <a href="#0" class="rating"><i class="far fa-star"></i></a>
                            <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                        </div>
                        <div class="auction-content">
                ...
                <div class="col-sm-10 col-md-6 col-lg-4">
                    <div class="auction-item-2" data-aos="zoom-out-up" data-aos-duration="1500">
                        <div class="auction-thumb">
                            <a href="./product-details.html"><img src="{{ asset('sbidu/assets/images/auction/jewelry/auction-3.jpg') }}" alt="jewelry"></a>
                            <a href="#0" class="rating"><i class="far fa-star"></i></a>
                            <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                        </div>
                        <div class="auction-content">
    ...
    <section class="call-in-section padding-top pt-max-xl-0">
        <div class="container">
            <div class="call-wrapper cl-white bg_img" data-background="{{ asset('sbidu/assets/images/call-in/call-bg.png') }}">
            ...
            <div class="row justify-content-center mb-30-none">
                <div class="col-sm-10 col-md-6 col-lg-4">
                    <div class="auction-item-2" data-aos="zoom-out-up" data-aos-duration="1600">
                        <div class="auction-thumb">
                            <a href="./product-details.html"><img src="{{ asset('sbidu/assets/images/auction/watches/auction-1.jpg') }}" alt="watches"></a>
                            <a href="#0" class="rating"><i class="far fa-star"></i></a>
                            <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                        </div>
                        <div class="auction-content">
                ...
                <div class="col-sm-10 col-md-6 col-lg-4">
                    <div class="auction-item-2" data-aos="zoom-out-up" data-aos-duration="1700">
                        <div class="auction-thumb">
                            <a href="./product-details.html"><img src="{{ asset('sbidu/assets/images/auction/watches/auction-2.jpg') }}" alt="watches"></a>
                            <a href="#0" class="rating"><i class="far fa-star"></i></a>
                            <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                        </div>
                        <div class="auction-content">
                ...
                <div class="col-sm-10 col-md-6 col-lg-4">
                    <div class="auction-item-2" data-aos="zoom-out-up" data-aos-duration="1800">
                        <div class="auction-thumb">
                            <a href="./product-details.html"><img src="{{ asset('sbidu/assets/images/auction/watches/auction-3.jpg') }}" alt="watches"></a>
                            <a href="#0" class="rating"><i class="far fa-star"></i></a>
                            <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                        </div>
                        <div class="auction-content">
