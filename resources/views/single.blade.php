                ...
                <ul class="product-tab-menu nav nav-tabs">
                    ...
                    <li>
                        <a href="#delevery" data-toggle="tab">
                            <div class="thumb">
                                <img src="{{ asset('sbidu/assets/images/product/tab2.png') }}" alt="product">
                            </div>
                    ...
                    <li>
                        <a href="#questions" data-toggle="tab">
                            <div class="thumb">
                                <img src="{{ asset('sbidu/assets/images/product/tab4.png') }}" alt="product">
                            </div>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade show" id="questions">
                        ...
                        <div class="faq-wrapper">
                            <div class="faq-item">
                                <div class="faq-title">
                                    <img src="{{ asset('sbidu/assets/css/img/faq.png') }}" alt="css"><span class="title">How to start bidding?</span><span class="right-icon"></span>
                                </div>
                            ...
                            <div class="faq-item">
                                <div class="faq-title">
                                    <img src="{{ asset('sbidu/assets/css/img/faq.png') }}" alt="css"><span class="title">Security Deposit / Bidding Power </span><span class="right-icon"></span>
                                </div>
                                <div class="faq-content">
                                    <p>All successful bidders can confirm their winning bid by checking the “Sbidu”. In addition, all successful bidders will receive an email notifying them of their winning bid after the auction closes.</p>
                                </div>
                            ...
                            <div class="faq-item">
                                <div class="faq-title">
                                    <img src="{{ asset('sbidu/assets/css/img/faq.png') }}" alt="css"><span class="title">Delivery time to the destination port </span><span class="right-icon"></span>
                                </div>
                                <div class="faq-content">
                                    <p>All successful bidders can confirm their winning bid by checking the “Sbidu”. In addition, all successful bidders will receive an email notifying them of their winning bid after the auction closes.</p>
                                </div>
                            ...
                            <div class="faq-item">
                                <div class="faq-title">
                                    <img src="{{ asset('sbidu/assets/css/img/faq.png') }}" alt="css"><span class="title">How to register to bid in an auction?</span><span class="right-icon"></span>
                                </div>
                                <div class="faq-content">
                                    <p>All successful bidders can confirm their winning bid by checking the “Sbidu”. In addition, all successful bidders will receive an email notifying them of their winning bid after the auction closes.</p>
                                </div>
                            ...
                            <div class="faq-item open active">
                                <div class="faq-title">
                                    <img src="{{ asset('sbidu/assets/css/img/faq.png') }}" alt="css"><span class="title">How will I know if my bid was successful?</span><span class="right-icon"></span>
                                </div>
                                <div class="faq-content">
                                    <p>All successful bidders can confirm their winning bid by checking the “Sbidu”. In addition, all successful bidders will receive an email notifying them of their winning bid after the auction closes.</p>
                                </div>
                            ...
                            <div class="faq-item">
                                <div class="faq-title">
                                    <img src="{{ asset('sbidu/assets/css/img/faq.png') }}" alt="css"><span class="title">What happens if I bid on the wrong lot?</span><span class="right-icon"></span>
                                </div>
                                <div class="faq-content">
                                    <p>All successful bidders can confirm their winning bid by checking the “Sbidu”. In addition, all successful bidders will receive an email notifying them of their winning bid after the auction closes.</p>
                                </div>
